...
public class ResultRetriverGetWorker implements Runnable {


    private ResultJob job;

    public ResultRetriverGetWorker(ResultJob job) {
    ...
    public void run() {
        ...
        if(!this.job.getPromth().contains("|")){
            ...
            System.out.println("Hint: Primer komande get web|google.com");
            return;
        }
            ...
            if(promth[1].equals("summary")){
                ...
                try {
                    synchronized (MainCLI.parentChildLinks) {
                        System.out.println("Cekam da ne bi doslo do konflikta sa citanjem i upisivanjem");
                    }
                ...
                System.out.println("Nepravilno unesena komanda");
                System.out.println("Hint: Unesite naziv domena koji ste uneli komandom aw ili summary kao drugi parametar");
            }
        }
        else{
            System.out.println("Nepravilno unesena komanda");
            System.out.println("Hint: Unesite web ili file kao prvi parametar");
        }
    }
